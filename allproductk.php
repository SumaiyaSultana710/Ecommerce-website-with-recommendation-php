...
<body>
    ...
    <section class="section-padding" id="B">
    	<div class="container">
            ...
            <div class="col-md-18">
    		    <div class="row">
                    ...
                    $sql = "SELECT * FROM products  where product_cat=11";
    ...
    <section class="section-padding" id="G">
        <div class="container">
            <div class="gallery-box">
            <div class="col-md-18">
                <div class="row">
    ...
    </section><section class="section-padding" id="A">
        <div class="container">
            <div class="gallery-box">
            <div class="col-md-18">
                <div class="row">
                    ...
                    $sql = "SELECT * FROM products  where product_cat=12";
                    $display = mysqli_query($con,$sql);
                    while($row= mysqli_fetch_array($display))
                    {
                ?>
