...
<body>
    ...
    <section class="section-padding" id="WC">
    	<div class="container">
    ...
    <section class="section-padding" id="WF">
        <div class="container">
            <div class="gallery-box">
            <div class="col-md-18">
                <div class="row">
                    ...
                    $sql = "SELECT * FROM products  where product_cat=6";
                    $display = mysqli_query($con,$sql);
                    while($row= mysqli_fetch_array($display))
                    {
                ?>
    ...
    </section><section class="section-padding" id="WW">
        <div class="container">
            <div class="gallery-box">
            <div class="col-md-18">
                <div class="row">
                    ...
                    $sql = "SELECT * FROM products  where product_cat=7";
                    $display = mysqli_query($con,$sql);
                    while($row= mysqli_fetch_array($display))
                    {
                ?>
    ...
    </section><section class="section-padding" id="WJ">
        <div class="container">
            <div class="gallery-box">
            <div class="col-md-18">
                <div class="row">
                    ...
                    $sql = "SELECT * FROM products  where product_cat=8";
                    $display = mysqli_query($con,$sql);
                    while($row= mysqli_fetch_array($display))
                    {
                ?>
    ...
    </section><section class="section-padding" id="WO">
        <div class="container">
            <div class="gallery-box">
            <div class="col-md-18">
                <div class="row">
