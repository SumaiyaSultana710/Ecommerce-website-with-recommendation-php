...
<body>
    	...
    	<div class="container">
            ...
            <div class="col-md-18">
    		    <div class="row">
                    ...
                    $sql = "SELECT * FROM products  where product_cat=16";
    ...
    <section class="section-padding" id="L">
        <div class="container">
            <div class="gallery-box">
            <div class="col-md-18">
                <div class="row">
                    ...
                    $sql = "SELECT * FROM products  where product_cat=17";
                    $display = mysqli_query($con,$sql);
                    while($row= mysqli_fetch_array($display))
                    {
                ?>
    ...
    <section class="section-padding" id="C">
        <div class="container">
            <div class="gallery-box">
            <div class="col-md-18">
                <div class="row">
                    ...
                    $sql = "SELECT * FROM products  where product_cat=18";
                    $display = mysqli_query($con,$sql);
                    while($row= mysqli_fetch_array($display))
                    {
                ?>
