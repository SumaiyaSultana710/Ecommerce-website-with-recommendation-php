...
<body>
    ...
    <section class="section-padding" id="HD">
    	<div class="container">
            ...
            <div class="col-md-18">
    		    <div class="row">
                    ...
                    $sql = "SELECT * FROM products  where product_cat=13";
    ...
    <section class="section-padding" id="KD">
        <div class="container">
            <div class="gallery-box">
            <div class="col-md-18">
                <div class="row">
                    ...
                    $sql = "SELECT * FROM products  where product_cat=14";
                    $display = mysqli_query($con,$sql);
                    while($row= mysqli_fetch_array($display))
                    {
                ?>
    ...
    </section><section class="section-padding" id="S">
        <div class="container">
            <div class="gallery-box">
            <div class="col-md-18">
                <div class="row">
                    ...
                    $sql = "SELECT * FROM products  where product_cat=15";
                    $display = mysqli_query($con,$sql);
                    while($row= mysqli_fetch_array($display))
                    {
                ?>
    ...
    </section><section class="section-padding" id="SB">
        <div class="container">
            <div class="gallery-box">
            <div class="col-md-18">
                <div class="row">
                    <h1>Seagrass Busket</h1>
                    <?php
                    if ($con->connect_error) {
                        die("Connection failed: " . $con->connect_error);
                    } 
                    $sql = "SELECT * FROM products  where product_cat=19";
                    $display = mysqli_query($con,$sql);
                    while($row= mysqli_fetch_array($display))
                    {
                ?>
